...
const About = () => {
  return (
    <div className="flex flex-col lg:flex-row lg:h-screen md:my-16 w-11/12 mx-auto gap-10">
      <div className="lg:w-3/6 py-10">
        <div>
          <h1
          data-aos="fade-up"
          ...
          className="text-4xl font-bold my-3">About Me</h1>
      ...
      <div className='lg:w-3/6 lg:my-14'>
        <h1 
        data-aos="fade-up"
        data-aos-anchor="#example-anchor"
        data-aos-offset="500"
        ...
        <div className="flex md:gap-5 w-3/6 flex-col lg:flex-row md:mt-5 lg:mt-0">
          <div
          data-aos="fade-left"
          data-aos-easing="linear"
          data-aos-duration="480"
          className="p-5 bg-slate-100 w-fit lg:my-5 rounded-lg font-semibold hover:bg-slate-200 shadow-lg hover:scale-105 duration-100 mt-5 md:mt-0"><p className="flex text-md"><MdOutlineMailOutline className="text-xl mt-1 mr-3 " />mdrifatulislam@gmail.com</p></div>
          <div
          data-aos="fade-left"
          data-aos-easing="linear"
          data-aos-duration="500"
          className="p-5 bg-slate-100 hover:bg-slate-200 w-60 lg:my-5 rounded-lg shadow-lg hover:scale-105 duration-100 mt-5 md:mt-0"><p className="flex text-md font-semibold"><IoCallOutline className="text-xl mt-1 mr-3 " /> +8801309727771</p></div>
        </div>
      </div>
